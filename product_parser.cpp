...
{
    Product* res = new Book("book", prodName_, price_, qty_, 
                    isbn_, author_);
    return res;
...
{
    Product* res = new Clothing("clothing", prodName_, price_, qty_, 
                    size_, brand_);
    return res;
}
...
{
    Product* res = new Movie("movie", prodName_, price_, qty_, 
                    genre_, rating_);
    return res;
}
